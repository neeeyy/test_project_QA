...
```
```
или скачайте репозиторий по ссылке:
```
```bash
https://github.com/neeeyy/test_project_QA/archive/refs/heads/master.zip
```
...
Скриншоты отчета в файле [docs](docs).
